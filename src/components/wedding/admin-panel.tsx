        ...
        >
          ...
          <div className="space-y-4 text-left">
            ...
            <p className="text-[10px] sm:text-xs text-stone-700/40 text-center mt-4 px-2">
              Contraseña por defecto: <span className="text-amber-600/70 font-mono">1303</span>
              <br />
              (cámbiala en <code className="text-amber-600/70">src/lib/wedding-config.ts</code>)
            </p>
          </div>
        </motion.div>
      </motion.div>
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-8 gap-2">
          ...
          <div className="flex gap-1.5 sm:gap-2 shrink-0">
            <Button
              variant="outline"
              onClick={exportCSV}
              className="border-amber-600/40 text-amber-700 hover:bg-amber-400/10 h-9 sm:h-10 px-2 sm:px-3 text-xs sm:text-sm"
            >
