  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col items-center justify-center px-5 py-16 sm:py-20 text-center overflow-hidden">
      ...
      >
        ...
        <p className="mt-4 sm:mt-6 text-amber-700/70 tracking-[0.25em] sm:tracking-[0.4em] uppercase text-[16px] sm:text-2xl font-sans">
          {tagline}
        </p>
        ...
        <p className="text-amber-700/80 text-[14px] sm:text-2xl tracking-[0.15em] sm:tracking-widest uppercase font-sans px-2">
          {loaded ? `${formatDateLong(weddingDate)} · ${formatTime(weddingDate)} hrs` : "···"}
        </p>

        <DecorativeDivider className="mt-8 sm:mt-12" />

        <p className="max-w-md text-stone-800/80 text-xl sm:text-2xl font-display font-semibold leading-relaxed italic px-1">
        ...
        <a
          href="#rsvp"
          className="mt-8 sm:mt-12 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-amber-700 via-amber-500 to-amber-700 px-6 sm:px-8 py-3 text-xl sm:text-2xl font-medium uppercase tracking-widest text-white hover:scale-105 transition-transform shadow-lg shadow-amber-700/20"
        >
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="text-amber-700/60 font-semibold text-[16px] tracking-widest">▼</div>
      </div>
    </section>
  );
}
      ...
      <div className="max-w-4xl mx-auto">
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[16px] sm:text-2xl uppercase tracking-widest text-amber-700/60 font-semibold">
                  {item.label}
                </div>
                <div className="text-xl sm:text-2xl font-display text-stone-800 break-words">
                  {item.value}
                </div>
              </div>
            </motion.div>
        ...
        {additionalInfo.giftNote && (
          ...
          >
            ...
            <div>
              <h3 className="font-serif text-xl sm:text-2xl text-stone-700 mb-2">Un detalle opcional</h3>
              <p className="text-stone-800/70 font-display font-semibold text-xl sm:text-2xl leading-relaxed italic">
                {additionalInfo.giftNote}
              </p>
            </div>
          </motion.div>
        ...
        >
          <div className="text-center">
            ...
            {loaded && settings.venueAddress && settings.venueAddress.trim() && (
              <p className="text-stone-800/70 font-display font-semibold text-xl sm:text-2xl mt-2 max-w-md mx-auto italic px-2">
    ...
    <section id="rsvp" className="py-12 sm:py-20 px-4 sm:px-6 relative scroll-mt-10">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <DecorativeDivider />
          <p className="text-stone-800/70 font-display font-semibold text-xl sm:text-2xl italic mt-4 px-2">
        ...
        {done ? (
          ...
          >
            <div>
              <Label htmlFor="name" className="text-amber-700/80 font-semibold tracking-widest uppercase text-[16px] sm:text-2xl">
                Nombre completo
              </Label>
              <Input
                id="name"
                ...
                className="mt-2 bg-white/70 border-amber-600/30 text-stone-800 placeholder:text-stone-400 font-display text-xl sm:text-2xl h-11"
              />
            </div>

            <div>
              <Label className="text-amber-700/80 font-semibold tracking-widest uppercase text-[16px] sm:text-2xl">
                ¿Asistirás?
              </Label>
              <div className="grid grid-cols-2 gap-2 sm:gap-3 mt-2">
                <button
                  ...
                  className={`rounded-lg sm:rounded-xl px-2 py-3 font-display text-xl sm:text-2xl border transition-all ${
                    attending === true
            ...
            {attending === true && (
              ...
              >
                <Label htmlFor="guests" className="text-amber-700/80 font-semibold tracking-widest uppercase text-[16px] sm:text-2xl">
            ...
            <div>
              <Label htmlFor="msg" className="text-amber-700/80 font-semibold tracking-widest uppercase text-[16px] sm:text-2xl">
              ...
              <Textarea
                ...
                className="mt-2 bg-white/70 border-amber-600/30 text-stone-800 placeholder:text-stone-400 font-display text-xl sm:text-2xl min-h-[90px]"
              />
            </div>
            ...
            <Button
              onClick={submit}
              disabled={loading}
              className="w-full bg-gradient-to-r from-amber-700 via-amber-500 to-amber-700 hover:from-amber-600 hover:via-amber-400 hover:to-amber-500 text-white font-medium tracking-widest uppercase rounded-full h-12 sm:h-14 text-xl sm:text-2xl shadow-lg shadow-amber-700/20"
            >
              {loading ? (
                <>
  ...
  return (
    <section className="py-12 sm:py-20 px-4 text-center">
      ...
      >
        ...
        <p className="font-display text-xl sm:text-3xl text-stone-800/90 font-medium italic leading-relaxed px-2">
          {weddingConfig.closingText}
        </p>
        <p className="mt-6 text-amber-700/70 tracking-[0.25em] sm:tracking-[0.3em] uppercase text-[16px] sm:text-2xl font-sans">
